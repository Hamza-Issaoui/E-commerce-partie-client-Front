...
const ProductDetails = () => {
  ...
  const dispatch = useDispatch()
    ...
    const {id} = useParams()
    //console.log("quntityyyy",quantity)
...
<img className="w-100 h-100" src={"http://localhost:4000/getfile/"+ img.name} alt="Image" />
</div>
    )
})}
      ...
      <div className="col-lg-7 pb-5">
        <h3 className="font-weight-semi-bold" style={{color:"red"}}>{product.ref}</h3>
        ...
        <h3 className="font-weight-semi-bold mb-4" style={{color:"red"}}>{product.price}</h3>
      ...
      <Radio value={1}>Blanc</Radio>
      <Radio value={2}>Rouge</Radio>
      <Radio value={3}>Bleu</Radio>
      <Radio value={4}>Jaune</Radio>
    </Radio.Group>
        ...
        <div className="d-flex align-items-center mb-4 pt-2">
          <div className="input-group quantity mr-3" style={{width: 130}}>
            <div className="input-group-btn">
              <button className="btn btn-primary btn-minus" onClick={() => {handelQuantity("dec")}} >
                <i className="fa fa-minus" />
              </button>
            </div>
            <input type="text" className="form-control bg-secondary text-center" value={quantity} />
            <div className="input-group-btn">
              <button className="btn btn-primary btn-plus" onClick={() => {handelQuantity("inc")}} >
